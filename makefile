chess: ChessMain.o ChessGame.o ChessPiece.o Colour.o Pawn.o Rook.o Knight.o Bishop.o Queen.o King.o
	g++ -Wall -g ChessMain.o ChessGame.o ChessPiece.o Colour.o Pawn.o Rook.o Knight.o Bishop.o Queen.o King.o -o chess
...
Queen.o: Queen.cpp ChessPiece.h Queen.h Colour.h Position.h
